...
// >> 정렬, 검색, 변환 등
public class D_Array { // 정적배열 끝(A~D_Array)
	public static void main(String[] args) {
		...
		// - 존재x : 음수 반환(검색 내용)
		System.out.println(Arrays.binarySearch(numbers, 3)); // 2, 찾고자 하는 3이 위치한 인덱스 2에서 발견됨
		...
		System.out.println(Arrays.equals(numbers, numbers2)); // F
		
		// 5. 배열의 채움
		// : Arrays.fill(배열, 삽입할 값);
		// - 배열의 모든 요소를 틀정 값으로 채움
