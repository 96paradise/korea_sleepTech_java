...
//		Optional<String> optional2 = Optional.of(null); // NullPointerException
		...
		System.out.println(optional1.isPresent()); // T
		System.out.println(optional1.isEmpty()); // F
		
		System.out.println(optional3.isPresent()); // F
		System.out.println(optional3.isEmpty()); // T
