...
//		do-while 문은 조건이 거짓이 될 때까지 반복됩니다.
//		왜 1~10 사이의 숫자만 나와야 할까?
//		1 미만(0, -1, -100 등)을 입력하면 조건 inputNumber < 1이 참이 되어 반복됨.
//		10 초과(11, 50, 100 등)를 입력하면 조건 inputNumber > 10이 참이 되어 반복됨.
//		오직 1 이상 10 이하(1~10)의 숫자를 입력해야 조건이 거짓이 되어 반복문이 종료됨.
	}
}
