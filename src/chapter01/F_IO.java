...
import java.util.Scanner; //Scanner에 ctrl + shift + o

public class F_IO {
	// main + (ctrl + space)
	// : class 파일 내부의 실행을 담당하는 메인 메서드
	public static void main(String[] args) {
		// === 자바의 기본 입출력(Input/Output -I O) === //
		...
		// 실행 단축키 : ctrl + f11
		System.out.println("안녕하세요 :)"); // ln 한줄 쓰기 : line(주어진 값을 콘솔에 출력하고 줄바꿈)
		
		System.out.print("안녕");
		System.out.println("하세요"); // 줄 복사 단축키 : ctrl + alt + 방향키
...
//		import java.util.Scanner;
		...
		int age = scanner.nextInt(); // 100 + \n(줄바꿈)  Console창에 문자,숫자 등 작성할 수 있음
		
		// 개행문자는 버퍼의 공간에 저장됨(임시 공간)
		
		System.out.println("키를 입력해주세요."); // 자동으로 줄바꿈 처리 + 200 + \n
		...
		// - 처리방법
		//		: nextLine()의 입력 메서드 호출로 벟퍼의 데이터를 사용(Enter 처리)
...
//		scanner.nextLine(); // close로 닫아서 스캐너 추가 안됨
