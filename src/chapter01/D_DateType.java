...
//		char lastName2 = "이"
		...
		String name = "최낙원";
//		 String welcomMessage = '만나서 반갑습니다 :)';
		
		char last = '최';
		
		System.out.println(name); // 최낙원
		System.out.println(last); // 최
