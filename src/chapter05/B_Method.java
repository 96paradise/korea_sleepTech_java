...
/*
 	...
 	+) 구현부
 	: 반환타입이 void가 아닐경우 반드시! 'retrun 반환타입데이터;' 포함해야 함!
 	>> 반환값은 명시된 반환타입과 일치하거나 자동형 변환이 가능한 데이터
...
class Example {
	...
	int add (int x, int y) { // 피라미터(매개변수) - 지역 변수
