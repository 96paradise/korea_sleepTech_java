...
public class D_Set {
	public static void main(String[] args) {
		// == Set 컬렉션의 주요 메서드 == //
		// : add(), remove(), contains(), size(), issEmpty()
		...
		System.out.println(falseResult); // F

		System.out.println(programming.size()); // 3

		System.out.println(programming.contains("파이썬")); // F
		System.out.println(programming.contains("자바")); // T

		System.out.println(programming.isEmpty()); // F
		programming.clear();
		System.out.println(programming.isEmpty()); // T
	}
}
