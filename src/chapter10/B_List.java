...
// - 연결 기반 데이터 관리 : 비순차적 데이터 작업에 적합, 특정 요소 접근 시 순차 탐색이 필요하여 성능이 저하
...
public class B_List {
	public static void main(String[] args) {
		...
		arrayList.add(0, "Python"); // 리스트 끝에 요소 추가
		arrayList.add("JavaScript"); // 리스트 끝에 요소 추가
		...
		System.out.println(linkedList.contains("Orange")); // T
		System.out.println(linkedList.contains("Strawberry")); // F
		...
		System.out.println(startTime); // 583499088961900
