...
public class B_Enum {
	public static void main(String[] args) {
		...
		// : 잘못된 문자열을 보낼 경우 IllegalArgmentException 발생
		
		Fruits orange = Fruits.valueOf("ORANGE"); // 대문자로 써야함, 안 그러면 오류
		...
		System.out.println(anotherSize + "'s ml : " + anotherSize.getMl() + "ml"); // LARGE's ml : 400ml
